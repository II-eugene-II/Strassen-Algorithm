...
int main()
{
	...
	register unsigned long long K = 282515649610;
	...
	for (i = 0; K < 6003785411879964839; i++)
	{
		...
		for (N = K; N < 6003785411879964839; N++, K++) // 6003785411879964839, 282515649610
		{
			...
			else if ((N % POW3_32) / POW3_28 == 40) // 915071698198440 = 40 * 81 * 81 * 81 * 81 * 81 * 81 * 81
			{
				N += POW3_28 - (N % POW3_28);
				K += POW3_28 - (K % POW3_28);
			...
			else if ((N % POW3_28) / POW3_24 == 40) // 11297181459240 = 40 * 81 * 81 * 81 * 81 * 81 * 81
			{
				N += POW3_24 - (N % POW3_24);
				K += POW3_24 - (K % POW3_24);
			...
			else if ((N % POW3_24) / POW3_20 == 40) // 40 * 81 * 81 * 81 * 81 * 81 = 139471376040
			{
				N += POW3_20 - (N % POW3_20);
				K += POW3_20 - (K % POW3_20);
			...
			else if ((N % POW3_20) / POW3_16 == 40) // 40 * 81 * 81 * 81 * 81 = 1721868840
			{
				N += POW3_16 - (N % POW3_16);
				K += POW3_16 - (K % POW3_16);
			...
			*/
			...
			else if ((N % POW3_16) / POW3_08 <= (N % POW3_24) / POW3_16)
			{
				...
				K += ((K % POW3_24) / POW3_16 - (K % POW3_16) / POW3_08) * POW3_08;
			...
			else if ((N % POW3_24) / POW3_16 <= (N % POW3_32) / POW3_24)
			{
				...
				K += ((K % POW3_32) / POW3_24 - (K % POW3_24) / POW3_16) * POW3_16;
			...
			else if ((N % POW3_32) / POW3_24 <= N / POW3_32)
			{
				...
				K += (K / POW3_32 - (K % POW3_32) / POW3_24) * POW3_24;
			...
			*/
			...
			else
			{
				...
				if (N % 65536 == 0)
				{
					...
					printf("%19llu, %llu, 프로그램 수행 시간 : %13lf초, %8d, %2d \n", N, N - K, (end - start), strassenTime, i + 1);
				}
			}
		}
		fclose(fp);    // 파일 포인터 닫기
